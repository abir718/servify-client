        ...
        <div className="bg-[#FCFBF3]">
            ...
            <div className="w-[80%] mx-auto bg-[#FFDEBF] my-10 p-10 rounded-lg lg:flex items-center justify-around">
                    <div className="flex flex-col gap-6">
                        ...
                        <button className="px-4 py-2 font-medium rounded-full text-white bg-black w-fit">Login or Sign up</button>
                    </div>
                    <div className="grid md:grid-cols-3 grid-cols-1 gap-10 lg:mt-1 mt-10">
                        <img className="w-60 rounded-lg" src="/images/imageone.png" alt="" />
                        <img className="w-60 rounded-lg" src="/images/imagetwo.png" alt="" />
                        <img className="w-60 rounded-lg" src="/images/imagethree.png" alt="" />
                    </div>
            </div>
            </div>
